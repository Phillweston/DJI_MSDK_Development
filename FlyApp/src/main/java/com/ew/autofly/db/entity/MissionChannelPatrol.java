...
@Entity(nameInDb = "t_Mission_ChannelPatrol")
public class MissionChannelPatrol extends MissionBase{
    ...
    @Generated(hash = 1628517475)
    public MissionChannelPatrol(Long id, String missionId, String missionBatchId,
            ...
            int routeOverlap, double resolutionRate, boolean isAltitudeFixed,
            int altitude, int flySpeed, int entryHeight, boolean isReverse,
            int channelEndExtend, int actionMode, int returnMode, int recodeMode,
            int baseLineHeight) {
        this.id = id;
    ...
    @Generated(hash = 1102053977)
    public MissionChannelPatrol() {
    }
    public Long getId() {
        return this.id;
    }
