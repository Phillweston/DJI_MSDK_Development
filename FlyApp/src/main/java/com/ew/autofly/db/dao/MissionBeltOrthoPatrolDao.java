...
/** 
 * DAO for table "t_Mission_BeltOrthoPatrol".
*/
public class MissionBeltOrthoPatrolDao extends AbstractDao<MissionBeltOrthoPatrol, Long> {

    public static final String TABLENAME = "t_Mission_BeltOrthoPatrol";

    /**
     * Properties of entity MissionBeltOrthoPatrol.<br/>
    ...
    public static class Properties {
        ...
        public final static Property RoutesNumber = new Property(22, int.class, "routesNumber", false, "ROUTES_NUMBER");
        public final static Property EndExtend = new Property(23, int.class, "endExtend", false, "END_EXTEND");
    }

    private final StringConverter geometryLatLngListConverter = new StringConverter();

    public MissionBeltOrthoPatrolDao(DaoConfig config) {
        super(config);
    }
    
    public MissionBeltOrthoPatrolDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"t_Mission_BeltOrthoPatrol\" (" + //
                ...
                "\"ROUTES_NUMBER\" INTEGER NOT NULL ," + // 22: routesNumber
                "\"END_EXTEND\" INTEGER NOT NULL );"); // 23: endExtend
    }

    /** Drops the underlying database table. */
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"t_Mission_BeltOrthoPatrol\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, MissionBeltOrthoPatrol entity) {
        stmt.clearBindings();
        ...
        stmt.bindLong(23, entity.getRoutesNumber());
        stmt.bindLong(24, entity.getEndExtend());
    }

    @Override
    protected final void bindValues(SQLiteStatement stmt, MissionBeltOrthoPatrol entity) {
        stmt.clearBindings();
    ...
    @Override
    public MissionBeltOrthoPatrol readEntity(Cursor cursor, int offset) {
        MissionBeltOrthoPatrol entity = new MissionBeltOrthoPatrol( //
            ...
            cursor.getInt(offset + 22), // routesNumber
            cursor.getInt(offset + 23) // endExtend
        );
        return entity;
    }
     
    @Override
    public void readEntity(Cursor cursor, MissionBeltOrthoPatrol entity, int offset) {
        ...
        entity.setRoutesNumber(cursor.getInt(offset + 22));
        entity.setEndExtend(cursor.getInt(offset + 23));
     }
    
    @Override
    protected final Long updateKeyAfterInsert(MissionBeltOrthoPatrol entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(MissionBeltOrthoPatrol entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(MissionBeltOrthoPatrol entity) {
