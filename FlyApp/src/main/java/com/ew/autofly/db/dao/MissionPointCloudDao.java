...
/** 
 * DAO for table "t_Mission_PointCloud".
*/
public class MissionPointCloudDao extends AbstractDao<MissionPointCloud, Long> {

    public static final String TABLENAME = "t_Mission_PointCloud";

    /**
     * Properties of entity MissionPointCloud.<br/>
    ...
    public static class Properties {
        ...
        public final static Property IsAltitudeFixed = new Property(19, boolean.class, "isAltitudeFixed", false, "IS_ALTITUDE_FIXED");
        public final static Property Altitude = new Property(20, int.class, "altitude", false, "ALTITUDE");
        public final static Property FlySpeed = new Property(21, int.class, "flySpeed", false, "FLY_SPEED");
        public final static Property RiseHeight = new Property(22, int.class, "riseHeight", false, "RISE_HEIGHT");
        public final static Property SideDistance = new Property(23, float.class, "sideDistance", false, "SIDE_DISTANCE");
        public final static Property LayerNumber = new Property(24, int.class, "layerNumber", false, "LAYER_NUMBER");
        public final static Property LayerHeight = new Property(25, float.class, "layerHeight", false, "LAYER_HEIGHT");
        public final static Property EndShrink = new Property(26, float.class, "endShrink", false, "END_SHRINK");
        public final static Property IsOtherSide = new Property(27, boolean.class, "isOtherSide", false, "IS_OTHER_SIDE");
    }

    private final StringConverter geometryLatLngListConverter = new StringConverter();

    public MissionPointCloudDao(DaoConfig config) {
        super(config);
    }
    
    public MissionPointCloudDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"t_Mission_PointCloud\" (" + //
                ...
                "\"IS_ALTITUDE_FIXED\" INTEGER NOT NULL ," + // 19: isAltitudeFixed
                "\"ALTITUDE\" INTEGER NOT NULL ," + // 20: altitude
                "\"FLY_SPEED\" INTEGER NOT NULL ," + // 21: flySpeed
                "\"RISE_HEIGHT\" INTEGER NOT NULL ," + // 22: riseHeight
                "\"SIDE_DISTANCE\" REAL NOT NULL ," + // 23: sideDistance
                "\"LAYER_NUMBER\" INTEGER NOT NULL ," + // 24: layerNumber
                "\"LAYER_HEIGHT\" REAL NOT NULL ," + // 25: layerHeight
                "\"END_SHRINK\" REAL NOT NULL ," + // 26: endShrink
                "\"IS_OTHER_SIDE\" INTEGER NOT NULL );"); // 27: isOtherSide
    }

    /** Drops the underlying database table. */
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"t_Mission_PointCloud\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, MissionPointCloud entity) {
        stmt.clearBindings();
        ...
        stmt.bindLong(20, entity.getIsAltitudeFixed() ? 1L: 0L);
        stmt.bindLong(21, entity.getAltitude());
        stmt.bindLong(22, entity.getFlySpeed());
        stmt.bindLong(23, entity.getRiseHeight());
        stmt.bindDouble(24, entity.getSideDistance());
        stmt.bindLong(25, entity.getLayerNumber());
        stmt.bindDouble(26, entity.getLayerHeight());
        stmt.bindDouble(27, entity.getEndShrink());
        stmt.bindLong(28, entity.getIsOtherSide() ? 1L: 0L);
    }

    @Override
    protected final void bindValues(SQLiteStatement stmt, MissionPointCloud entity) {
        stmt.clearBindings();
    ...
    @Override
    public MissionPointCloud readEntity(Cursor cursor, int offset) {
        MissionPointCloud entity = new MissionPointCloud( //
            ...
            cursor.getShort(offset + 19) != 0, // isAltitudeFixed
            cursor.getInt(offset + 20), // altitude
            cursor.getInt(offset + 21), // flySpeed
            cursor.getInt(offset + 22), // riseHeight
            cursor.getFloat(offset + 23), // sideDistance
            cursor.getInt(offset + 24), // layerNumber
            cursor.getFloat(offset + 25), // layerHeight
            cursor.getFloat(offset + 26), // endShrink
            cursor.getShort(offset + 27) != 0 // isOtherSide
        );
        return entity;
    }
     
    @Override
    public void readEntity(Cursor cursor, MissionPointCloud entity, int offset) {
        ...
        entity.setIsAltitudeFixed(cursor.getShort(offset + 19) != 0);
        entity.setAltitude(cursor.getInt(offset + 20));
        entity.setFlySpeed(cursor.getInt(offset + 21));
        entity.setRiseHeight(cursor.getInt(offset + 22));
        entity.setSideDistance(cursor.getFloat(offset + 23));
        entity.setLayerNumber(cursor.getInt(offset + 24));
        entity.setLayerHeight(cursor.getFloat(offset + 25));
        entity.setEndShrink(cursor.getFloat(offset + 26));
        entity.setIsOtherSide(cursor.getShort(offset + 27) != 0);
     }
    
    @Override
    protected final Long updateKeyAfterInsert(MissionPointCloud entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(MissionPointCloud entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(MissionPointCloud entity) {
