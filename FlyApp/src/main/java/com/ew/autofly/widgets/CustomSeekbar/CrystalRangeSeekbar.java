...
public class CrystalRangeSeekbar extends View {
    ...
    public CrystalRangeSeekbar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        try{
            ...
            portion                = (this.minValue / (this.maxValue - 1)) * 100;
        }
        finally {
            array.recycle();
        }
    ...
    public void apply(){
        ...
        portion = (minValue / (maxValue - 1)) * 100;
    ...
    protected int getBarColor(final TypedArray typedArray){
        return typedArray.getColor(R.styleable.CrystalRangeSeekbar_bar_color, Color.parseColor("#DADADA"));
    }

    protected int getBarHighlightColor(final TypedArray typedArray){
        return typedArray.getColor(R.styleable.CrystalRangeSeekbar_bar_highlight_color, Color.parseColor("#25E0E7"));
    }

    protected int getLeftThumbColor(final TypedArray typedArray){
        return typedArray.getColor(R.styleable.CrystalRangeSeekbar_left_thumb_color, Color.parseColor("#25E0E7"));
    }

    protected int getRightThumbColor(final TypedArray typedArray){
        return typedArray.getColor(R.styleable.CrystalRangeSeekbar_right_thumb_color, Color.parseColor("#25E0E7"));
    }
    ...
    protected float getDiameter(final TypedArray typedArray){
        return typedArray.getDimensionPixelSize(R.styleable.CrystalRangeSeekbar_thumb_diameter, 60);
    }
    ...
    private void setNormalizedMinValue(double value) {
        normalizedMinValue = Math.max(0d, Math.min(100d, Math.min(value, normalizedMaxValue - portion)));
    ...
    private void setNormalizedMaxValue(double value) {
        normalizedMaxValue = Math.max(0d, Math.min(100d, Math.max(value, normalizedMinValue + portion)));
