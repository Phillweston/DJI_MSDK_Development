package com.ew.autofly.widgets.colorpicker;
...
public class ColorPickerDialog extends Dialog implements ColorPickerView.OnColorChangedListener,
    ...
    private SeekBar mTranseSeekBar;
    ...
    private void setUp(int color) {
        ...
        mTranseSeekBar = (SeekBar) layout.findViewById(R.id.trans_seekbar);
        int transe = Color.alpha(color);
        mTranseSeekBar.setProgress(transe);
        mTranseSeekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            @Override
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                int c = mNewColor.getColor();
                mAlpha = (int) (2.55 * progress);
                int c1 = Color.argb(mAlpha, Color.red(c), Color.green(c), Color.blue(c));
                mNewColor.setColor(c1);
            }
    ...
    @Override
    public void onColorChanged(int color) {
        int c1 = Color.argb(mAlpha, Color.red(color), Color.green(color), Color.blue(color));
