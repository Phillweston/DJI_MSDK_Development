...
/**
 * @author ：admin on 2019/5/16 12:46
 * @description ：进度圆环
 */
/**
 * ProgressRing类继承自{@link View}，以圆环图形的形式显示百分比数值。
 * <p>
 * 在设置百分比值时可以使用方法{@link #setPercent(float)}不包含动画效果，或者方法
 * {@link #animatToPercent(float)}包含过渡动画效果。
 *
 * @attr ref cn.changwentao.lemon.R.styleable#ProgressRing_heartColor
 * @attr ref cn.changwentao.lemon.R.styleable#ProgressRing_heartClickedColor
 * @attr ref cn.changwentao.lemon.R.styleable#ProgressRing_skinStartColor
 * @attr ref cn.changwentao.lemon.R.styleable#ProgressRing_skinEndColor
 * @attr ref cn.changwentao.lemon.R.styleable#ProgressRing_skinDepth
 * @attr ref cn.changwentao.lemon.R.styleable#ProgressRing_percent
 * @attr ref cn.changwentao.lemon.R.styleable#ProgressRing_duration
 * @attr ref cn.changwentao.lemon.R.styleable#ProgressRing_centerTextColor
 */
public class ProgressRing extends View {
    ...
    /**
     * 构建一个默认样式的{@link ProgressRing}对象。
     *
     * @param context
     *            Context上下文对象
     */
    ...
    /**
     * 根据xml文件提供的属性值构建一个{@link ProgressRing}对象。
     *
     * @param context
     *            Context上下文对象
     */
    ...
    public ProgressRing(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.getTheme().obtainStyledAttributes(attrs,
                R.styleable.Ux_ProgressRing, 0, 0);
        try {
            mTextColor = a.getColor(R.styleable.Ux_ProgressRing_pr_centerTextColor,
                    DEFAULT_TEXT_COLOR);
            mHeartColor = a.getColor(R.styleable.Ux_ProgressRing_pr_heartColor,
                    DEFAULT_HEART_COLOR_NORMAL);
            mHeartClickedColor = a.getColor(
                    R.styleable.Ux_ProgressRing_pr_heartClickedColor,
                    DEFAULT_HEART_COLOR_CLICKED);
            setAnimationDuration(a.getInt(R.styleable.Ux_ProgressRing_pr_duration,
                    (int) DEFAULT_ANIMATION_LENGTH));
            if (!a.hasValue(R.styleable.Ux_ProgressRing_pr_skinStartColor)
                    ^ a.hasValue(R.styleable.Ux_ProgressRing_pr_skinEndColor)) {
                mSkinStartColor = a.getColor(
                        R.styleable.Ux_ProgressRing_pr_skinStartColor,
                        DEFAULT_SKIN_START_COLOR);
                mSkinEndColor = a.getColor(
                        R.styleable.Ux_ProgressRing_pr_skinEndColor,
                        DEFAULT_SKIN_END_COLOR);
            } else if (a.hasValue(R.styleable.Ux_ProgressRing_pr_skinStartColor)) {
            ...
            mSkinDepth = a.getInt(R.styleable.Ux_ProgressRing_pr_skinDepth,
                    DEFAULT_SKIN_DEPTH);
            mPercent = a.getFloat(R.styleable.Ux_ProgressRing_pr_percent, 0f);
                        ...
                        if (alwaysKeepInHeart && pointInLemonHeart(x, y)) {
                            ...
                            if (mOnHeartClickListener != null) {
                                mOnHeartClickListener
                                        .onHeartClick(ProgressRing.this);
                            }
                        }
                        alwaysKeepInHeart = false;
                        return true;
    ...
    public interface OnPercentAnimationEndListener {
         ...
         *            ProgressRing对象
         */
        void onPercentAnimationEnd(ProgressRing lemon);
    }
    ...
    public interface OnHeartClickListener {
         ...
         *            ProgressRing对象
         */
        void onHeartClick(ProgressRing lemon);
    }
    ...
    static class SavedState extends BaseSavedState {
        ...
        public String toString() {
            return "ProgressRing.SavedState{"
     ...
     * @param color
     *            文字颜色
     * @attr ref cn.changwentao.lemon.R#ProgressRing_centerTextColor
     */
     ...
     * @param heartColor
     *            中心圆颜色
     * @attr ref cn.changwentao.lemon.R#ProgressRing_heartColor
     */
     ...
     *            中心圆点击颜色
     * @attr ref cn.changwentao.lemon.R#ProgressRing_heartClickedColor
     */
     ...
     * @param endColor
     *            结束颜色
     * @attr ref cn.changwentao.lemon.R#ProgressRing_skinStartColor
     * @attr ref cn.changwentao.lemon.R#ProgressRing_skinEndColor
     */
     ...
     *             如果传递的参数值不在1到50之间
     * @attr ref cn.changwentao.lemon.R#ProgressRing_skinDepth
     */
     ...
     * @throws IllegalArgumentException
     *             如果传递的参数值不在0到100之间
     * @attr ref cn.changwentao.lemon.R#ProgressRing_percent
     */
    @SuppressLint("NewApi")
