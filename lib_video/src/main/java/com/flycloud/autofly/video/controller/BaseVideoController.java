...
public abstract class BaseVideoController
     ...
     *                  <ul>
     *                  <li>{@link IVideoPlayer#STATE_IDLE}</li>
     *                  <li>{@link IVideoPlayer#STATE_PREPARING}</li>
     *                  <li>{@link IVideoPlayer#STATE_PREPARED}</li>
     *                  <li>{@link IVideoPlayer#STATE_PLAYING}</li>
     *                  <li>{@link IVideoPlayer#STATE_PAUSED}</li>
     *                  <li>{@link IVideoPlayer#STATE_BUFFERING_PLAYING}</li>
     *                  <li>{@link IVideoPlayer#STATE_BUFFERING_PAUSED}</li>
     *                  <li>{@link IVideoPlayer#STATE_ERROR}</li>
     *                  <li>{@link IVideoPlayer#STATE_COMPLETED}</li>
     *                  </ul>
     */
     ...
     *                 <ul>
     *                 <li>{@link IVideoPlayer#MODE_NORMAL}</li>
     *                 <li>{@link IVideoPlayer#MODE_FULL_SCREEN}</li>
     *                 <li>{@link IVideoPlayer#MODE_TINY_WINDOW}</li>
     *                 </ul>
     */
